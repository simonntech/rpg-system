      ...
      <div className="relative group">
        ...
        {onDelete && (
          <button
            ...
            className="absolute top-10 right-2 z-20 bg-red-900/90 hover:bg-red-600 text-white p-2 rounded-xl border border-red-950/50 transition-colors opacity-0 group-hover:opacity-100 shadow-lg"
            title="Excluir herói"
          >
            <svg
